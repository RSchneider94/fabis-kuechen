Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'https://fabiskuechen.herokuapp.com', 'https://fabiskuechen.herokuapp.com' ]
  ...
  # config.active_job.queue_name_prefix = "fabis-kuechen_#{Rails.env}"
